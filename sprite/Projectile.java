...
public class Projectile extends Sprite{
     ...
     * 
     */
    public Projectile(double x, double y, double futurex, double futurey, String projectileSprite, int range, double speed, int damage) {
        super(x, y, null);
        startx = x;
        starty = y;
        distanceX = futurex - x;
     ...
     * 
     */
    public Projectile(double x, double y, double futurex, double futurey, Image projectileImage, int range, double speed, int damage) {
        super(x, y, null);
        startx = x;
        starty = y;
        distanceX = futurex - x;
