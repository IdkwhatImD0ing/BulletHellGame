...
public class Geb extends Enemy {
	...
	/**
	 * Second fire function Fires ring of bullets
	 */
	public void fire2() {
		if (visible) {
			board.getEnemyProjectiles().add(new Projectile(x + getWidth() / 2, y + getHeight() / 2, 0,
					"src/Enemies/Boss/GebBullet2.png", 2000, 7, 30));
	...
	/**
	 * Die function Gives xp Drops loot when dead
	 */
	public void die() {
