...
public class Medusa extends Enemy{
	...
	public void fire(Point2D point) {
		if (visible) {
			board.getEnemyProjectiles().add(new Projectile(x + getWidth()/2, y + getHeight()/2, point.getX(), point.getY(), "src/Enemies/Medusa/MedusaBullet.png", 700, 3, 25 + 3 * board.getRound()));
			board.getEnemyProjectiles().add(new Projectile(x + getWidth()/2, y + getHeight()/2, getTargetAngle() - ANGLE, "src/Enemies/Medusa/MedusaBullet.png", 700, 3, 25 + 3 * board.getRound()));
			board.getEnemyProjectiles().add(new Projectile(x + getWidth()/2, y + getHeight()/2, getTargetAngle() + ANGLE, "src/Enemies/Medusa/MedusaBullet.png", 700, 3, 25 + 3 * board.getRound()));
		}
    }
